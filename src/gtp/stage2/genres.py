...
Defines the coarse genre set used as `GENRE<X>` tokens in the encoder
prefix, plus the keyword-rule table used to coarse-grain DadaGP's 739
fine-grained genre tags.
...
# 10-bucket canonical set. Order doesn't matter functionally, but vocab
